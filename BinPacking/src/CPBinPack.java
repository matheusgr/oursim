...
public class CPBinPack {
	...
	private Model model; // a model object, to attach variables and
	// constraints
	private IntegerVariable inBin[][]; // inBin[i][j] = 1 iff jth number is in
	// ith bin
	...
	public CPBinPack(String fname, int numberOfItems, int numberOfBins, int capacity) throws Exception {
		...
		//
		// constrain a piece of data such that it can only be in one bin at a
		// time!
	...
	public IntegerVariable getTotBinsUsed() {
		return totBinsUsed;
	}
	...
	public String toString(Solver sol) {
		String s = id + " " + " #items: " + n + " #bins: " + m + " capacity: " + c + "\n";
	...
	public static void main(String[] args) throws FileNotFoundException, IOException, Exception {
		...
		// StaticVarOrder(s.getVar(bp.getDecisionVars())));
		//
