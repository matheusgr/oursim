...
import br.edu.ufcg.lsd.oursim.io.input.OnDemandGWANorduGridWorkload;
...
public class CLI {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		if (cmd.hasOption(WORKLOAD) && cmd.hasOption(NUM_RESOURCES_BY_PEER)) {
		...
		} else if (cmd.hasOption(WORKLOAD) && cmd.hasOption(MACHINES) && cmd.hasOption(AVAILABILITY) && cmd.hasOption(NUM_PEERS)) {
			...
			availability = new AvailabilityCharacterization(machineAvailabilityFilePath, 1062597562, true);
